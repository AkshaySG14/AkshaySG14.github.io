...
class ChargerSourceCode extends React.Component {
    render() {
        return (
            <PrismCode component="pre" className="language-java">{`package com.inoculates.knight.enemies;
...
export default ChargerSourceCode;