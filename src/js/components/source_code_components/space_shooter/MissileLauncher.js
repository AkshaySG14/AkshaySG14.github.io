...
class MissileLauncherSourceCode extends React.Component {
    render() {
        return (
            <PrismCode component="pre" className="language-ruby">{`require 'gosu'
...
export default MissileLauncherSourceCode;