...
class CameraSourceCode extends React.Component {
    render() {
        return (
            <PrismCode component="pre" className="language-ruby">{`#This class determines whether an object will be drawn, and more importantly where it will be drawn.
class Camera
  attr_accessor :camX
  attr_accessor :camY
  attr_accessor :width
...
export default CameraSourceCode;