...
class YellowLighterSourceCode extends React.Component {
    render() {
        return (
            <PrismCode component="pre" className="language-java">{`package com.inoculates.dal.Sprites;
...
export default YellowLighterSourceCode;