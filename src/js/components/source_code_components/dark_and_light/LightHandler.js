...
class LightHandlerSourceCode extends React.Component {
    render() {
        return (
            <PrismCode component="pre" className="language-java">{`package com.inoculates.dal.WorldHandlers;
...
export default LightHandlerSourceCode;