...
class GraphicsHelperSourceCode extends React.Component {
    render() {
        return (
            <PrismCode component="pre" className="language-python">{`#Class intended to return the pygame surface from the image path. Essentially converts the string path into an image the
#library can use.
import pygame
...
export default GraphicsHelperSourceCode;