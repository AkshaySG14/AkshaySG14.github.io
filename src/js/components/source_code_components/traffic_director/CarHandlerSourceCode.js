...
class CarHandlerSourceCode extends React.Component {
    render() {
        return (
            <PrismCode component="pre" className="language-python">{`import GraphicsHelper
import pygame
import random
...
export default CarHandlerSourceCode;